-- ============================================================
-- Phase 3 Seed Data — Modules 2–12 with Quizzes & Assignments
...
insert into public.assignments (id, module_id, title, instructions, required) values (
  ...
  'Module 2 Assignment – Test Design Techniques',
...
insert into public.quizzes (id, module_id, title, pass_mark) values (
  ...
  'b1000002-0000-0000-0000-000000000001',
  'Module 2 Quiz – Test Design Techniques',
  70
);
...
-- Q3
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d2000003-0000-0000-0000-000000000001', 'c1000002-0000-0000-0000-000000000001', 'For an age field that accepts 18–65, which values would you test using Boundary Value Analysis?', 'multiple_choice', 3);
insert into public.quiz_answers (question_id, answer_text, is_correct) values
...
('d2000004-0000-0000-0000-000000000001', 'Simultaneous learning, test design, and execution — structured but not scripted', true),
...
insert into public.assignments (id, module_id, title, instructions, required) values ('e1000003-0000-0000-0000-000000000001', 'b1000003-0000-0000-0000-000000000001', 'Module 3 Assignment – Defect Management', 'Find and document 10 potential defects from any website or application using the Defect Report Template. For each defect include: title, steps to reproduce, expected result, actual result, severity, priority, and at least one screenshot or evidence attachment. Submit as a PDF or DOCX.', true);

insert into public.quizzes (id, module_id, title, pass_mark) values ('c1000003-0000-0000-0000-000000000001', 'b1000003-0000-0000-0000-000000000001', 'Module 3 Quiz – Defect Management', 70);
...
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d4000001-0000-0000-0000-000000000001', '1 day', false), ('d4000001-0000-0000-0000-000000000001', '1–4 weeks, commonly 2 weeks', true), ('d4000001-0000-0000-0000-000000000001', '3 months', false), ('d4000001-0000-0000-0000-000000000001', '6 months', false);
...
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d5000002-0000-0000-0000-000000000001', 'c1000005-0000-0000-0000-000000000001', 'In Jira, what does the "To Do → In Progress → Done" flow represent?', 'multiple_choice', 2);
...
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d6000003-0000-0000-0000-000000000001', 'Server error', false), ('d6000003-0000-0000-0000-000000000001', 'Not found — the requested resource does not exist', true), ('d6000003-0000-0000-0000-000000000001', 'Unauthorised', false), ('d6000003-0000-0000-0000-000000000001', 'Request successful', false);
...
insert into public.assignments (id, module_id, title, instructions, required) values ('e1000007-0000-0000-0000-000000000001', 'b1000007-0000-0000-0000-000000000001', 'Module 7 Assignment – SQL for Testers', 'Complete the SQL practice pack (provided in the workbook): write 20 SQL queries covering SELECT, WHERE, ORDER BY, GROUP BY, and JOIN, provide 5 data validation examples showing how you would use SQL to verify test data, and write 3 short explanations of how SQL has helped or would help you as a tester. Submit as a PDF or DOCX.', true);

insert into public.quizzes (id, module_id, title, pass_mark) values ('c1000007-0000-0000-0000-000000000001', 'b1000007-0000-0000-0000-000000000001', 'Module 7 Quiz – SQL for Testers', 70);
...
-- MODULES 8–12: Update descriptions + add assignments + quizzes (condensed)
...
-- Quizzes for modules 8-12 (5 questions each — admin can add more later)
insert into public.quizzes (id, module_id, title, pass_mark) values
('c1000008-0000-0000-0000-000000000001', 'b1000008-0000-0000-0000-000000000001', 'Module 8 Quiz – Automation Fundamentals', 70),
('c1000009-0000-0000-0000-000000000001', 'b1000009-0000-0000-0000-000000000001', 'Module 9 Quiz – AI for Software Testing', 70),
('c1000010-0000-0000-0000-000000000001', 'b1000010-0000-0000-0000-000000000001', 'Module 10 Quiz – Portfolio Building', 70),
('c1000011-0000-0000-0000-000000000001', 'b1000011-0000-0000-0000-000000000001', 'Module 11 Quiz – CV & LinkedIn Mastery', 70),
('c1000012-0000-0000-0000-000000000001', 'b1000012-0000-0000-0000-000000000001', 'Module 12 Quiz – Interview Mastery & Job Search', 70);
...
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d9000010-0000-0000-0000-000000000001', 'AI will replace all manual testers within 2 years', false), ('d9000010-0000-0000-0000-000000000001', 'AI is a productivity tool that augments testers — human judgment remains essential', true), ('d9000010-0000-0000-0000-000000000001', 'AI has no useful role in testing yet', false), ('d9000010-0000-0000-0000-000000000001', 'AI only helps with automation, not manual testing', false);

-- Module 10 questions (Portfolio)
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d10000001-0000-0000-0000-000000000001', 'c1000010-0000-0000-0000-000000000001', 'Why is a QA portfolio important for job seekers?', 'multiple_choice', 1);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d10000001-0000-0000-0000-000000000001', 'It is required by law', false), ('d10000001-0000-0000-0000-000000000001', 'It provides tangible evidence of your testing skills to employers', true), ('d10000001-0000-0000-0000-000000000001', 'It replaces the need for a CV', false), ('d10000001-0000-0000-0000-000000000001', 'It is only useful for automation engineers', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d10000002-0000-0000-0000-000000000001', 'c1000010-0000-0000-0000-000000000001', 'True or False: A QA portfolio should only contain automation code.', 'true_false', 2);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d10000002-0000-0000-0000-000000000001', 'True', false), ('d10000002-0000-0000-0000-000000000001', 'False', true);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d10000003-0000-0000-0000-000000000001', 'c1000010-0000-0000-0000-000000000001', 'Which platform is commonly used to host a QA portfolio?', 'multiple_choice', 3);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d10000003-0000-0000-0000-000000000001', 'Instagram', false), ('d10000003-0000-0000-0000-000000000001', 'GitHub', true), ('d10000003-0000-0000-0000-000000000001', 'TikTok', false), ('d10000003-0000-0000-0000-000000000001', 'Reddit', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d10000004-0000-0000-0000-000000000001', 'c1000010-0000-0000-0000-000000000001', 'What should a portfolio README include?', 'multiple_choice', 4);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d10000004-0000-0000-0000-000000000001', 'Personal diary entries', false), ('d10000004-0000-0000-0000-000000000001', 'About you, projects covered, tools used, and links to evidence', true), ('d10000004-0000-0000-0000-000000000001', 'Your salary expectations', false), ('d10000004-0000-0000-0000-000000000001', 'Your manager''s contact details', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d10000005-0000-0000-0000-000000000001', 'c1000010-0000-0000-0000-000000000001', 'True or False: Using a real application (with permission) to create portfolio evidence is better than using made-up data.', 'true_false', 5);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d10000005-0000-0000-0000-000000000001', 'True', true), ('d10000005-0000-0000-0000-000000000001', 'False', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d10000006-0000-0000-0000-000000000001', 'c1000010-0000-0000-0000-000000000001', 'Which of these would make the strongest portfolio evidence?', 'multiple_choice', 6);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d10000006-0000-0000-0000-000000000001', 'A blank test case template', false), ('d10000006-0000-0000-0000-000000000001', 'A complete test pack for a real application with executed test cases and a defect report', true), ('d10000006-0000-0000-0000-000000000001', 'A screenshot of your desktop', false), ('d10000006-0000-0000-0000-000000000001', 'A list of tools you have heard of', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d10000007-0000-0000-0000-000000000001', 'c1000010-0000-0000-0000-000000000001', 'What is a README file?', 'multiple_choice', 7);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d10000007-0000-0000-0000-000000000001', 'A type of test case', false), ('d10000007-0000-0000-0000-000000000001', 'A document that explains a project — what it is, how to use it, and what is inside', true), ('d10000007-0000-0000-0000-000000000001', 'A legal disclaimer', false), ('d10000007-0000-0000-0000-000000000001', 'A configuration file', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d10000008-0000-0000-0000-000000000001', 'c1000010-0000-0000-0000-000000000001', 'True or False: You should only include work you are 100% proud of in your portfolio.', 'true_false', 8);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d10000008-0000-0000-0000-000000000001', 'True', false), ('d10000008-0000-0000-0000-000000000001', 'False', true);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d10000009-0000-0000-0000-000000000001', 'c1000010-0000-0000-0000-000000000001', 'Why is it important to include a variety of artefact types in your portfolio?', 'multiple_choice', 9);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d10000009-0000-0000-0000-000000000001', 'To make it look longer', false), ('d10000009-0000-0000-0000-000000000001', 'To demonstrate breadth of testing skills across different areas', true), ('d10000009-0000-0000-0000-000000000001', 'To confuse the recruiter', false), ('d10000009-0000-0000-0000-000000000001', 'It is not important', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d10000010-0000-0000-0000-000000000001', 'c1000010-0000-0000-0000-000000000001', 'Where should you include your portfolio link?', 'multiple_choice', 10);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d10000010-0000-0000-0000-000000000001', 'Only in job applications when specifically asked', false), ('d10000010-0000-0000-0000-000000000001', 'On your CV, LinkedIn profile, and in job applications', true), ('d10000010-0000-0000-0000-000000000001', 'Nowhere — let employers find it themselves', false), ('d10000010-0000-0000-0000-000000000001', 'Only on LinkedIn', false);

-- Module 11 questions (CV & LinkedIn)
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d11000001-0000-0000-0000-000000000001', 'c1000011-0000-0000-0000-000000000001', 'What should the personal profile at the top of a QA CV include?', 'multiple_choice', 1);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d11000001-0000-0000-0000-000000000001', 'Your hobbies and weekend activities', false), ('d11000001-0000-0000-0000-000000000001', 'A concise summary of your skills, background, and what you are looking for', true), ('d11000001-0000-0000-0000-000000000001', 'Your previous salary', false), ('d11000001-0000-0000-0000-000000000001', 'Your school grades', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d11000002-0000-0000-0000-000000000001', 'c1000011-0000-0000-0000-000000000001', 'True or False: You should tailor your CV for each job you apply to.', 'true_false', 2);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d11000002-0000-0000-0000-000000000001', 'True', true), ('d11000002-0000-0000-0000-000000000001', 'False', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d11000003-0000-0000-0000-000000000001', 'c1000011-0000-0000-0000-000000000001', 'What does a recruiter typically spend looking at a CV first?', 'multiple_choice', 3);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d11000003-0000-0000-0000-000000000001', '30 minutes', false), ('d11000003-0000-0000-0000-000000000001', '6–10 seconds on initial scan', true), ('d11000003-0000-0000-0000-000000000001', '1 hour', false), ('d11000003-0000-0000-0000-000000000001', '5 minutes reading every word', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d11000004-0000-0000-0000-000000000001', 'c1000011-0000-0000-0000-000000000001', 'What is the LinkedIn "Open to Work" feature?', 'multiple_choice', 4);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d11000004-0000-0000-0000-000000000001', 'A way to view other people''s CVs', false), ('d11000004-0000-0000-0000-000000000001', 'A signal to recruiters that you are actively looking for work', true), ('d11000004-0000-0000-0000-000000000001', 'A job board within LinkedIn', false), ('d11000004-0000-0000-0000-000000000001', 'A way to block recruiters', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d11000005-0000-0000-0000-000000000001', 'c1000011-0000-0000-0000-000000000001', 'True or False: You should include every job you have ever had on your QA CV.', 'true_false', 5);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d11000005-0000-0000-0000-000000000001', 'True', false), ('d11000005-0000-0000-0000-000000000001', 'False', true);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d11000006-0000-0000-0000-000000000001', 'c1000011-0000-0000-0000-000000000001', 'Which keywords are most important to include on a QA CV?', 'multiple_choice', 6);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d11000006-0000-0000-0000-000000000001', 'Generic words like "hardworking" and "team player"', false), ('d11000006-0000-0000-0000-000000000001', 'Role-specific terms: SDLC, Agile, Jira, defect management, test cases, API testing', true), ('d11000006-0000-0000-0000-000000000001', 'Your favourite programming language', false), ('d11000006-0000-0000-0000-000000000001', 'The names of your previous managers', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d11000007-0000-0000-0000-000000000001', 'c1000011-0000-0000-0000-000000000001', 'What is the ideal length for a QA CV?', 'multiple_choice', 7);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d11000007-0000-0000-0000-000000000001', '5–6 pages with full detail', false), ('d11000007-0000-0000-0000-000000000001', '1–2 pages, concise and relevant', true), ('d11000007-0000-0000-0000-000000000001', 'As long as needed', false), ('d11000007-0000-0000-0000-000000000001', 'Exactly 1 page only', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d11000008-0000-0000-0000-000000000001', 'c1000011-0000-0000-0000-000000000001', 'True or False: Adding your portfolio link to your LinkedIn profile increases your chances of being contacted by recruiters.', 'true_false', 8);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d11000008-0000-0000-0000-000000000001', 'True', true), ('d11000008-0000-0000-0000-000000000001', 'False', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d11000009-0000-0000-0000-000000000001', 'c1000011-0000-0000-0000-000000000001', 'What are transferable skills for a career changer moving into QA?', 'multiple_choice', 9);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d11000009-0000-0000-0000-000000000001', 'Skills irrelevant to any role', false), ('d11000009-0000-0000-0000-000000000001', 'Skills from previous roles that apply to QA: attention to detail, communication, analysis, process following', true), ('d11000009-0000-0000-0000-000000000001', 'Technical certifications only', false), ('d11000009-0000-0000-0000-000000000001', 'Management experience only', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d11000010-0000-0000-0000-000000000001', 'c1000011-0000-0000-0000-000000000001', 'How often should you update your LinkedIn profile?', 'multiple_choice', 10);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d11000010-0000-0000-0000-000000000001', 'Only when you get a new job', false), ('d11000010-0000-0000-0000-000000000001', 'Regularly — add new skills, projects and achievements as you gain them', true), ('d11000010-0000-0000-0000-000000000001', 'Once a decade', false), ('d11000010-0000-0000-0000-000000000001', 'Never — leave it as it is', false);

-- Module 12 questions (Interview & Job Search)
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d12000001-0000-0000-0000-000000000001', 'c1000012-0000-0000-0000-000000000001', 'What does STAR stand for in interview technique?', 'multiple_choice', 1);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d12000001-0000-0000-0000-000000000001', 'Skills, Tasks, Actions, Results', false), ('d12000001-0000-0000-0000-000000000001', 'Situation, Task, Action, Result', true), ('d12000001-0000-0000-0000-000000000001', 'Strengths, Targets, Achievements, Review', false), ('d12000001-0000-0000-0000-000000000001', 'Scenario, Testing, Analysis, Report', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d12000002-0000-0000-0000-000000000001', 'c1000012-0000-0000-0000-000000000001', 'True or False: It is acceptable to say "I don''t know" in a QA interview if you genuinely don''t know the answer.', 'true_false', 2);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d12000002-0000-0000-0000-000000000001', 'True', true), ('d12000002-0000-0000-0000-000000000001', 'False', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d12000003-0000-0000-0000-000000000001', 'c1000012-0000-0000-0000-000000000001', 'What is the most common first interview stage for a QA role?', 'multiple_choice', 3);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d12000003-0000-0000-0000-000000000001', 'A coding challenge', false), ('d12000003-0000-0000-0000-000000000001', 'A telephone or video screening with HR or a recruiter', true), ('d12000003-0000-0000-0000-000000000001', 'A full day assessment centre', false), ('d12000003-0000-0000-0000-000000000001', 'A written exam', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d12000004-0000-0000-0000-000000000001', 'c1000012-0000-0000-0000-000000000001', 'When should you research a company before an interview?', 'multiple_choice', 4);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d12000004-0000-0000-0000-000000000001', 'Only if they ask you to', false), ('d12000004-0000-0000-0000-000000000001', 'Always — before every interview, understand the company, product, and culture', true), ('d12000004-0000-0000-0000-000000000001', 'Only for senior roles', false), ('d12000004-0000-0000-0000-000000000001', 'After the interview', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d12000005-0000-0000-0000-000000000001', 'c1000012-0000-0000-0000-000000000001', 'True or False: You should always ask questions at the end of a QA interview.', 'true_false', 5);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d12000005-0000-0000-0000-000000000001', 'True', true), ('d12000005-0000-0000-0000-000000000001', 'False', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d12000006-0000-0000-0000-000000000001', 'c1000012-0000-0000-0000-000000000001', 'What is a "scenario question" in a QA interview?', 'multiple_choice', 6);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d12000006-0000-0000-0000-000000000001', 'A question about your salary expectations', false), ('d12000006-0000-0000-0000-000000000001', 'A question describing a situation and asking how you would handle it as a tester', true), ('d12000006-0000-0000-0000-000000000001', 'A question about your previous company''s processes', false), ('d12000006-0000-0000-0000-000000000001', 'A question about your personal life', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d12000007-0000-0000-0000-000000000001', 'c1000012-0000-0000-0000-000000000001', 'What is a realistic job search timeline for a career changer into QA?', 'multiple_choice', 7);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d12000007-0000-0000-0000-000000000001', '1–2 days', false), ('d12000007-0000-0000-0000-000000000001', '1–6 months of active, structured job searching', true), ('d12000007-0000-0000-0000-000000000001', 'It should happen immediately after completing training', false), ('d12000007-0000-0000-0000-000000000001', 'At least 2 years', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d12000008-0000-0000-0000-000000000001', 'c1000012-0000-0000-0000-000000000001', 'True or False: Networking on LinkedIn can lead to job opportunities that are not advertised publicly.', 'true_false', 8);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d12000008-0000-0000-0000-000000000001', 'True', true), ('d12000008-0000-0000-0000-000000000001', 'False', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d12000009-0000-0000-0000-000000000001', 'c1000012-0000-0000-0000-000000000001', 'What should you focus on in your first 90 days in a QA role?', 'multiple_choice', 9);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d12000009-0000-0000-0000-000000000001', 'Immediately proposing process changes', false), ('d12000009-0000-0000-0000-000000000001', 'Learning the product, team, processes and tools — asking questions and building relationships', true), ('d12000009-0000-0000-0000-000000000001', 'Finding everything that is wrong', false), ('d12000009-0000-0000-0000-000000000001', 'Working independently without asking for help', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('d12000010-0000-0000-0000-000000000001', 'c1000012-0000-0000-0000-000000000001', 'What should you do after a job rejection?', 'multiple_choice', 10);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('d12000010-0000-0000-0000-000000000001', 'Stop applying immediately', false), ('d12000010-0000-0000-0000-000000000001', 'Ask for feedback, reflect on the interview, and continue your job search', true), ('d12000010-0000-0000-0000-000000000001', 'Contact the hiring manager repeatedly', false), ('d12000010-0000-0000-0000-000000000001', 'Give up on QA', false);
