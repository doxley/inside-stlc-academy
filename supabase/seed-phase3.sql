...
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('da000001-0000-0000-0000-000000000001', 'c1000010-0000-0000-0000-000000000001', 'Why is a QA portfolio important for job seekers?', 'multiple_choice', 1);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('da000001-0000-0000-0000-000000000001', 'It is required by law', false), ('da000001-0000-0000-0000-000000000001', 'It provides tangible evidence of your testing skills to employers', true), ('da000001-0000-0000-0000-000000000001', 'It replaces the need for a CV', false), ('da000001-0000-0000-0000-000000000001', 'It is only useful for automation engineers', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('da000002-0000-0000-0000-000000000001', 'c1000010-0000-0000-0000-000000000001', 'True or False: A QA portfolio should only contain automation code.', 'true_false', 2);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('da000002-0000-0000-0000-000000000001', 'True', false), ('da000002-0000-0000-0000-000000000001', 'False', true);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('da000003-0000-0000-0000-000000000001', 'c1000010-0000-0000-0000-000000000001', 'Which platform is commonly used to host a QA portfolio?', 'multiple_choice', 3);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('da000003-0000-0000-0000-000000000001', 'Instagram', false), ('da000003-0000-0000-0000-000000000001', 'GitHub', true), ('da000003-0000-0000-0000-000000000001', 'TikTok', false), ('da000003-0000-0000-0000-000000000001', 'Reddit', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('da000004-0000-0000-0000-000000000001', 'c1000010-0000-0000-0000-000000000001', 'What should a portfolio README include?', 'multiple_choice', 4);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('da000004-0000-0000-0000-000000000001', 'Personal diary entries', false), ('da000004-0000-0000-0000-000000000001', 'About you, projects covered, tools used, and links to evidence', true), ('da000004-0000-0000-0000-000000000001', 'Your salary expectations', false), ('da000004-0000-0000-0000-000000000001', 'Your manager''s contact details', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('da000005-0000-0000-0000-000000000001', 'c1000010-0000-0000-0000-000000000001', 'True or False: Using a real application (with permission) to create portfolio evidence is better than using made-up data.', 'true_false', 5);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('da000005-0000-0000-0000-000000000001', 'True', true), ('da000005-0000-0000-0000-000000000001', 'False', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('da000006-0000-0000-0000-000000000001', 'c1000010-0000-0000-0000-000000000001', 'Which of these would make the strongest portfolio evidence?', 'multiple_choice', 6);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('da000006-0000-0000-0000-000000000001', 'A blank test case template', false), ('da000006-0000-0000-0000-000000000001', 'A complete test pack for a real application with executed test cases and a defect report', true), ('da000006-0000-0000-0000-000000000001', 'A screenshot of your desktop', false), ('da000006-0000-0000-0000-000000000001', 'A list of tools you have heard of', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('da000007-0000-0000-0000-000000000001', 'c1000010-0000-0000-0000-000000000001', 'What is a README file?', 'multiple_choice', 7);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('da000007-0000-0000-0000-000000000001', 'A type of test case', false), ('da000007-0000-0000-0000-000000000001', 'A document that explains a project — what it is, how to use it, and what is inside', true), ('da000007-0000-0000-0000-000000000001', 'A legal disclaimer', false), ('da000007-0000-0000-0000-000000000001', 'A configuration file', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('da000008-0000-0000-0000-000000000001', 'c1000010-0000-0000-0000-000000000001', 'True or False: You should only include work you are 100% proud of in your portfolio.', 'true_false', 8);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('da000008-0000-0000-0000-000000000001', 'True', false), ('da000008-0000-0000-0000-000000000001', 'False', true);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('da000009-0000-0000-0000-000000000001', 'c1000010-0000-0000-0000-000000000001', 'Why is it important to include a variety of artefact types in your portfolio?', 'multiple_choice', 9);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('da000009-0000-0000-0000-000000000001', 'To make it look longer', false), ('da000009-0000-0000-0000-000000000001', 'To demonstrate breadth of testing skills across different areas', true), ('da000009-0000-0000-0000-000000000001', 'To confuse the recruiter', false), ('da000009-0000-0000-0000-000000000001', 'It is not important', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('da00000a-0000-0000-0000-000000000001', 'c1000010-0000-0000-0000-000000000001', 'Where should you include your portfolio link?', 'multiple_choice', 10);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('da00000a-0000-0000-0000-000000000001', 'Only in job applications when specifically asked', false), ('da00000a-0000-0000-0000-000000000001', 'On your CV, LinkedIn profile, and in job applications', true), ('da00000a-0000-0000-0000-000000000001', 'Nowhere — let employers find it themselves', false), ('da00000a-0000-0000-0000-000000000001', 'Only on LinkedIn', false);

-- Module 11 questions (CV & LinkedIn)
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('db000001-0000-0000-0000-000000000001', 'c1000011-0000-0000-0000-000000000001', 'What should the personal profile at the top of a QA CV include?', 'multiple_choice', 1);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('db000001-0000-0000-0000-000000000001', 'Your hobbies and weekend activities', false), ('db000001-0000-0000-0000-000000000001', 'A concise summary of your skills, background, and what you are looking for', true), ('db000001-0000-0000-0000-000000000001', 'Your previous salary', false), ('db000001-0000-0000-0000-000000000001', 'Your school grades', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('db000002-0000-0000-0000-000000000001', 'c1000011-0000-0000-0000-000000000001', 'True or False: You should tailor your CV for each job you apply to.', 'true_false', 2);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('db000002-0000-0000-0000-000000000001', 'True', true), ('db000002-0000-0000-0000-000000000001', 'False', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('db000003-0000-0000-0000-000000000001', 'c1000011-0000-0000-0000-000000000001', 'What does a recruiter typically spend looking at a CV first?', 'multiple_choice', 3);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('db000003-0000-0000-0000-000000000001', '30 minutes', false), ('db000003-0000-0000-0000-000000000001', '6–10 seconds on initial scan', true), ('db000003-0000-0000-0000-000000000001', '1 hour', false), ('db000003-0000-0000-0000-000000000001', '5 minutes reading every word', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('db000004-0000-0000-0000-000000000001', 'c1000011-0000-0000-0000-000000000001', 'What is the LinkedIn "Open to Work" feature?', 'multiple_choice', 4);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('db000004-0000-0000-0000-000000000001', 'A way to view other people''s CVs', false), ('db000004-0000-0000-0000-000000000001', 'A signal to recruiters that you are actively looking for work', true), ('db000004-0000-0000-0000-000000000001', 'A job board within LinkedIn', false), ('db000004-0000-0000-0000-000000000001', 'A way to block recruiters', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('db000005-0000-0000-0000-000000000001', 'c1000011-0000-0000-0000-000000000001', 'True or False: You should include every job you have ever had on your QA CV.', 'true_false', 5);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('db000005-0000-0000-0000-000000000001', 'True', false), ('db000005-0000-0000-0000-000000000001', 'False', true);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('db000006-0000-0000-0000-000000000001', 'c1000011-0000-0000-0000-000000000001', 'Which keywords are most important to include on a QA CV?', 'multiple_choice', 6);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('db000006-0000-0000-0000-000000000001', 'Generic words like "hardworking" and "team player"', false), ('db000006-0000-0000-0000-000000000001', 'Role-specific terms: SDLC, Agile, Jira, defect management, test cases, API testing', true), ('db000006-0000-0000-0000-000000000001', 'Your favourite programming language', false), ('db000006-0000-0000-0000-000000000001', 'The names of your previous managers', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('db000007-0000-0000-0000-000000000001', 'c1000011-0000-0000-0000-000000000001', 'What is the ideal length for a QA CV?', 'multiple_choice', 7);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('db000007-0000-0000-0000-000000000001', '5–6 pages with full detail', false), ('db000007-0000-0000-0000-000000000001', '1–2 pages, concise and relevant', true), ('db000007-0000-0000-0000-000000000001', 'As long as needed', false), ('db000007-0000-0000-0000-000000000001', 'Exactly 1 page only', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('db000008-0000-0000-0000-000000000001', 'c1000011-0000-0000-0000-000000000001', 'True or False: Adding your portfolio link to your LinkedIn profile increases your chances of being contacted by recruiters.', 'true_false', 8);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('db000008-0000-0000-0000-000000000001', 'True', true), ('db000008-0000-0000-0000-000000000001', 'False', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('db000009-0000-0000-0000-000000000001', 'c1000011-0000-0000-0000-000000000001', 'What are transferable skills for a career changer moving into QA?', 'multiple_choice', 9);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('db000009-0000-0000-0000-000000000001', 'Skills irrelevant to any role', false), ('db000009-0000-0000-0000-000000000001', 'Skills from previous roles that apply to QA: attention to detail, communication, analysis, process following', true), ('db000009-0000-0000-0000-000000000001', 'Technical certifications only', false), ('db000009-0000-0000-0000-000000000001', 'Management experience only', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('db00000a-0000-0000-0000-000000000001', 'c1000011-0000-0000-0000-000000000001', 'How often should you update your LinkedIn profile?', 'multiple_choice', 10);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('db00000a-0000-0000-0000-000000000001', 'Only when you get a new job', false), ('db00000a-0000-0000-0000-000000000001', 'Regularly — add new skills, projects and achievements as you gain them', true), ('db00000a-0000-0000-0000-000000000001', 'Once a decade', false), ('db00000a-0000-0000-0000-000000000001', 'Never — leave it as it is', false);

-- Module 12 questions (Interview & Job Search)
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('dc000001-0000-0000-0000-000000000001', 'c1000012-0000-0000-0000-000000000001', 'What does STAR stand for in interview technique?', 'multiple_choice', 1);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('dc000001-0000-0000-0000-000000000001', 'Skills, Tasks, Actions, Results', false), ('dc000001-0000-0000-0000-000000000001', 'Situation, Task, Action, Result', true), ('dc000001-0000-0000-0000-000000000001', 'Strengths, Targets, Achievements, Review', false), ('dc000001-0000-0000-0000-000000000001', 'Scenario, Testing, Analysis, Report', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('dc000002-0000-0000-0000-000000000001', 'c1000012-0000-0000-0000-000000000001', 'True or False: It is acceptable to say "I don''t know" in a QA interview if you genuinely don''t know the answer.', 'true_false', 2);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('dc000002-0000-0000-0000-000000000001', 'True', true), ('dc000002-0000-0000-0000-000000000001', 'False', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('dc000003-0000-0000-0000-000000000001', 'c1000012-0000-0000-0000-000000000001', 'What is the most common first interview stage for a QA role?', 'multiple_choice', 3);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('dc000003-0000-0000-0000-000000000001', 'A coding challenge', false), ('dc000003-0000-0000-0000-000000000001', 'A telephone or video screening with HR or a recruiter', true), ('dc000003-0000-0000-0000-000000000001', 'A full day assessment centre', false), ('dc000003-0000-0000-0000-000000000001', 'A written exam', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('dc000004-0000-0000-0000-000000000001', 'c1000012-0000-0000-0000-000000000001', 'When should you research a company before an interview?', 'multiple_choice', 4);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('dc000004-0000-0000-0000-000000000001', 'Only if they ask you to', false), ('dc000004-0000-0000-0000-000000000001', 'Always — before every interview, understand the company, product, and culture', true), ('dc000004-0000-0000-0000-000000000001', 'Only for senior roles', false), ('dc000004-0000-0000-0000-000000000001', 'After the interview', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('dc000005-0000-0000-0000-000000000001', 'c1000012-0000-0000-0000-000000000001', 'True or False: You should always ask questions at the end of a QA interview.', 'true_false', 5);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('dc000005-0000-0000-0000-000000000001', 'True', true), ('dc000005-0000-0000-0000-000000000001', 'False', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('dc000006-0000-0000-0000-000000000001', 'c1000012-0000-0000-0000-000000000001', 'What is a "scenario question" in a QA interview?', 'multiple_choice', 6);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('dc000006-0000-0000-0000-000000000001', 'A question about your salary expectations', false), ('dc000006-0000-0000-0000-000000000001', 'A question describing a situation and asking how you would handle it as a tester', true), ('dc000006-0000-0000-0000-000000000001', 'A question about your previous company''s processes', false), ('dc000006-0000-0000-0000-000000000001', 'A question about your personal life', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('dc000007-0000-0000-0000-000000000001', 'c1000012-0000-0000-0000-000000000001', 'What is a realistic job search timeline for a career changer into QA?', 'multiple_choice', 7);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('dc000007-0000-0000-0000-000000000001', '1–2 days', false), ('dc000007-0000-0000-0000-000000000001', '1–6 months of active, structured job searching', true), ('dc000007-0000-0000-0000-000000000001', 'It should happen immediately after completing training', false), ('dc000007-0000-0000-0000-000000000001', 'At least 2 years', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('dc000008-0000-0000-0000-000000000001', 'c1000012-0000-0000-0000-000000000001', 'True or False: Networking on LinkedIn can lead to job opportunities that are not advertised publicly.', 'true_false', 8);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('dc000008-0000-0000-0000-000000000001', 'True', true), ('dc000008-0000-0000-0000-000000000001', 'False', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('dc000009-0000-0000-0000-000000000001', 'c1000012-0000-0000-0000-000000000001', 'What should you focus on in your first 90 days in a QA role?', 'multiple_choice', 9);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('dc000009-0000-0000-0000-000000000001', 'Immediately proposing process changes', false), ('dc000009-0000-0000-0000-000000000001', 'Learning the product, team, processes and tools — asking questions and building relationships', true), ('dc000009-0000-0000-0000-000000000001', 'Finding everything that is wrong', false), ('dc000009-0000-0000-0000-000000000001', 'Working independently without asking for help', false);
insert into public.quiz_questions (id, quiz_id, question_text, question_type, sort_order) values ('dc00000a-0000-0000-0000-000000000001', 'c1000012-0000-0000-0000-000000000001', 'What should you do after a job rejection?', 'multiple_choice', 10);
insert into public.quiz_answers (question_id, answer_text, is_correct) values ('dc00000a-0000-0000-0000-000000000001', 'Stop applying immediately', false), ('dc00000a-0000-0000-0000-000000000001', 'Ask for feedback, reflect on the interview, and continue your job search', true), ('dc00000a-0000-0000-0000-000000000001', 'Contact the hiring manager repeatedly', false), ('dc00000a-0000-0000-0000-000000000001', 'Give up on QA', false);
