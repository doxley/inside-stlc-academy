...
-- ---------- Wire template_slug + brief_slug to Resource Vault docs ----------
-- (Resources are generated by scripts/resources/build.mjs into
-- public/resources/qa-leadership-academy/. Idempotent.)
update public.assignments a set template_slug = v.template_slug, brief_slug = v.brief_slug
from (values
  (1,  'qa-leader-first-30-days-checklist',     'qal-m1-assignment-brief'),
  (2,  'qa-maturity-assessment',                'qal-m2-assignment-brief'),
  (3,  'qa-skills-matrix',                       'qal-m3-assignment-brief'),
  (4,  'qa-job-description-template',            'qal-m4-assignment-brief'),
  (5,  'qa-strategy-template',                   'qal-m5-assignment-brief'),
  (6,  'go-no-go-decision-template',             'qal-m6-assignment-brief'),
  (7,  'qa-metrics-catalogue',                   'qal-m7-assignment-brief'),
  (8,  'automation-assessment',                  'qal-m8-assignment-brief'),
  (9,  'ai-qa-use-case-matrix',                  'qal-m9-assignment-brief'),
  (10, 'stakeholder-map',                        'qal-m10-assignment-brief'),
