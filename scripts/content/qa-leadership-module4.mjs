...
- **Applying the assessment inconsistently** or failing to offer reasonable adjustments, creating unfairness and legal exposure`,
      ...
      enhancements: {
        industryStory: `[DAVID INPUT REQUIRED: Add a genuine story about a take-home or practical assessment that went too far — either one you were given as a candidate that crossed the line, or one a team you advised was using that was quietly driving away strong applicants — and specifically what you changed to make it fair and still predictive.]`,
        visualAid: {
          type: 'tree',
...
- **Deciding by panel consensus or seniority** rather than by evidence and the gap — and either dithering until candidates walk, or rushing past a "none of them" that the evidence actually supported`,
      ...
      enhancements: {
        industryStory: `[DAVID INPUT REQUIRED: Add a genuine story of a close senior hiring decision where the "obviously best" candidate on paper was not the right hire for the team's actual gap — how you (or a team you advised) reasoned from the gap to a less obvious choice, and how it turned out. This is the emotional centre of the module and a real, non-generic anecdote here would land hard.]`,
        visualAid: {
          type: 'matrix',
