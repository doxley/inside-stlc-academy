...
- **Confusing being needed with being effective** — a leader everyone depends on for everything has built a fragile team, not a strong one`,
      ...
      enhancements: {
        industryStory: `[DAVID INPUT REQUIRED: Add a short, authentic story from your own move into leadership — ideally the first time you realised that "doing it yourself" had quietly made you the team's bottleneck, and what specific thing you stopped doing to break the pattern.]`,
        visualAid: {
          type: 'comparison',
...
- **Ignoring organisational politics** and then being surprised when a sound strategy dies in a meeting`,
      ...
      enhancements: {
        industryStory: `[DAVID INPUT REQUIRED: Add an example from your consultancy work of an organisation where the QA approach was technically sound but wrong for the context — e.g. too heavyweight for the delivery model, or too light for the regulatory risk — and how reading the context changed the recommendation.]`,
        visualAid: {
          type: 'comparison',
